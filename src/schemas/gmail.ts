...
export const GMAIL_LABEL_COLORS = [
  ...
  "#e66550", "#ffbc6b", "#fcda83", "#5dc28c", "#74db9b", "#6d9eeb", "#b694e8", "#f7a7c0",
  "#cc3a21", "#eaa041", "#f2c960", "#149e60", "#44b984", "#3c78d8", "#8e63ce", "#e07798",
  "#ac2b16", "#cf8933", "#d5ae49", "#0b804b", "#339966", "#285bac", "#653e9b", "#b65775",
...
const gmailLabelColorSchema = z
  ...
  .refine(
    (color) =>
      GMAIL_LABEL_COLORS.includes(color.toLowerCase() as GmailLabelColor),
    {
