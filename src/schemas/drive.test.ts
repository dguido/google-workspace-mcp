...
describe('SearchSchema', () => {
  ...
  it('accepts optional pageToken', () => {
    const result = SearchSchema.safeParse({ query: 'test', pageToken: 'abc123' });
    expect(result.success).toBe(true);
  });
...
describe('CreateTextFileSchema', () => {
  it('accepts valid input', () => {
    const result = CreateTextFileSchema.safeParse({ name: 'file.txt', content: 'hello' });
    expect(result.success).toBe(true);
  });
  ...
  it('rejects empty name', () => {
    const result = CreateTextFileSchema.safeParse({ name: '', content: 'hello' });
    expect(result.success).toBe(false);
  });

  it('accepts empty content', () => {
    const result = CreateTextFileSchema.safeParse({ name: 'file.txt', content: '' });
    expect(result.success).toBe(true);
  });
});
...
describe('UpdateTextFileSchema', () => {
  it('accepts valid input', () => {
    const result = UpdateTextFileSchema.safeParse({ fileId: 'abc123', content: 'new content' });
    expect(result.success).toBe(true);
  });
  ...
  it('rejects empty fileId', () => {
    const result = UpdateTextFileSchema.safeParse({ fileId: '', content: 'content' });
    expect(result.success).toBe(false);
  });
});
...
describe('CreateFolderSchema', () => {
  ...
  it('accepts optional parent', () => {
    const result = CreateFolderSchema.safeParse({ name: 'NewFolder', parent: 'parent123' });
    expect(result.success).toBe(true);
  });
...
describe('RenameItemSchema', () => {
  it('accepts valid input', () => {
    const result = RenameItemSchema.safeParse({ itemId: 'item123', newName: 'NewName' });
    expect(result.success).toBe(true);
  });

  it('rejects empty itemId', () => {
    const result = RenameItemSchema.safeParse({ itemId: '', newName: 'NewName' });
    expect(result.success).toBe(false);
  });

  it('rejects empty newName', () => {
    const result = RenameItemSchema.safeParse({ itemId: 'item123', newName: '' });
    expect(result.success).toBe(false);
  });
});
