...
MCP server providing Claude access to Google Drive, Docs, Sheets, and Slides.
...
This opens your browser for Google OAuth consent. Tokens are saved to `~/.config/google-drive-mcp/tokens.json`.
...
| `GOOGLE_DRIVE_MCP_TOKEN_PATH` | Custom token storage location |

Tokens are stored at `~/.config/google-drive-mcp/tokens.json` by default.
...
- [GitHub Repository](https://github.com/dguido/google-drive-mcp)
